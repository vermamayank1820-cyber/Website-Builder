...
- Gradients/texture: use at most sparingly and only when they carry the brand (e.g. a single quiet tonal gradient as a section ground, a fine grid or hairline rules for an editorial/architectural feel). Never use mesh gradients, glows, or blurred blobs as background filler. Default to solid, considered color fields.
